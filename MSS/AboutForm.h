...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label3->Location = System::Drawing::Point(195, 125);
			...
			this->pictureBox1->Location = System::Drawing::Point(209, 74);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(99, 50);
			...
			this->label4->Location = System::Drawing::Point(223, 138);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(71, 13);
			this->label4->TabIndex = 4;
			this->label4->Text = L"rambrera.com";
			...
			this->AutoSize = true;
			this->ClientSize = System::Drawing::Size(532, 162);
